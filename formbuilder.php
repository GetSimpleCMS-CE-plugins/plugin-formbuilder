...
function formbuilder_list() {
    ...
    echo '</div>';
    echo '<p style="margin:20px 0;padding:15px;border:solid 1px #ddd;background:#fafafa;border-radius:5px;">Is this plugin useful to you?
	
				<span class="w3-btn w3-khaki w3-border w3-border-red w3-round-xlarge">
					<a href="https://ko-fi.com/multicolorplugins" target="_blank" class="donateButton">
						<b>Buy Me A Coffee </b>
						<svg xmlns="http://www.w3.org/2000/svg" style="vertical-align:middle" width="24" height="24" viewBox="0 0 24 24">
